...
if __name__ == '__main__':
    ...
    parser.add_argument('-model_path', type=str, default='./models3/model-0/model-0_best.pt', help='trained model path')
    ...
    parser.add_argument('-threshold', type=float, default=0.05 , help='threshold to cut off crack response')
